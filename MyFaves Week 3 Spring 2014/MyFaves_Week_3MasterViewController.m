//
//  MyFaves_Week_3MasterViewController.m
...
#import "MyFaves_Week_3MasterViewController.h"

#import "MyFaves_Week_3DetailViewController.h"

@interface MyFaves_Week_3MasterViewController () {
    NSMutableArray *_objects;
}
@end

@implementation MyFaves_Week_3MasterViewController
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (MyFaves_Week_3DetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //closes Menu
    self.detailViewController.detailItem = @"loading Website";
